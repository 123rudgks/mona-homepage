...
export const DUMMY_NEWS: Array<{
...
}> = [
  {
    ...
    content:
      '오늘날 기업들은 다양한 클라우드 환경과 수 많은 애플리케이션을 비즈니스에서 활용하고 있으며, 이 환경은 생성형 AI의 도입으로 더욱 복잡해지고 있다. 생성형 AI가 2028년까지 최대 10억 개의 앱을 만들어낼 것으로 예상되는 상황에서 자동화는 더 이상 선택 사항이 아니다.” 이은주 한국IBM 사장은 13일 서울 여의도 담회 오늘날 기업들은 다양한 클라우드 환경과 수 많은 애플리케이션을 비즈니스에서 활용하고 있으며, 이 환경은 생성형 AI의 도입으로 더욱 복잡해지고 있다. 생성형 AI가 2028년까지 최대 10억 개의 앱을 만들어낼 것으로 예상되는 상황에서 자동화는 더 이상 선택 사항이 아니다.” 이은주 한국IBM 사장은 13일 서울 여의도 담회 오늘날 기업들은 다양한 클라우드 환경과 수 많은 애플리케이션을 비즈니스에서 활용하고 있으며, 이 환경은 생성형 AI의 도입으로 더욱 복잡해지고 있다. 생성형 AI가 2028년까지 최대 10억 개의 앱을 만들어낼 것으로 예상되는 상황에서 자동화는 더 이상 선택 사항이 아니다.” 이은주 한국IBM 사장은 13일 서울 여의도 담회 ',
    ...
    <div
      ...
      <div className="flex-1 flex flex-col sm-screen:gap-[14px]">
        ...
        <div
          ...
          <div className="sm-screen:line-clamp-4 line-clamp-2">{content}</div>
